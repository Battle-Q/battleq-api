...
import com.study.battleq.modules.board.service.dto.BoardSearchDto;
...
public class BoardApiController {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "게시글 저장 성공", content = @Content(schema = @Schema(implementation = Long.class))),
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "게시글 조회 성공", content = @Content(schema = @Schema(implementation = BoardSearchDto.class))),
    ...
    public ResponseDto<List> findByTitle(@Parameter(name = "title", description = "게시글 제목", in = ParameterIn.PATH) @PathVariable("title") String title){
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "게시글 수정 성공", content = @Content(schema = @Schema(implementation = Long.class))),
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "게시글 삭제 성공", content = @Content(schema = @Schema(implementation = Long.class))),
            @ApiResponse(responseCode = "404", description = "존재하지 않는 리소스 접근(게시글 식별자, 유저 권한등)", content = @Content(schema = @Schema(implementation = Exception.class)))
    })
